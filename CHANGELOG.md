...
- **MCP server SyntaxError fix** — the dynamic tool factory was emitting `def _tool(title: Optional[str] = None, message: str):` (required-after-optional → SyntaxError). All 72 tools now register cleanly.
